...
/**
 * One partner moment as a trigger of the webhook manager.
 *
 ...
 */
class AffiliatesTrigger implements TriggerInterface
{
    ...
    {
        return (string) __('affiliates::webhooks.triggers.'.$this->moment);
    }

    public function description(): ?string
    {
        $key = 'affiliates::webhooks.descriptions.'.$this->moment;
        $text = __($key);
